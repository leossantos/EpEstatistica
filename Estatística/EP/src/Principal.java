...
//metodo para ler o arquivo e atribuis os valores aos arrays
     ...
     */
    public static double[][] guardarNotas(int[] prova, int quantidade) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        */
        ...
        /**
         * 3.4
         * Intervalo de confiança utilizando a distribuição t student 
         * Utilizando a formula
         * inicio do Interval = media - desvio * 1,645
         * fim do Interval = media + desvio * 1,645
         * media = media das amostras
         * desvio = desvio padrao das amostras
         * 1,645 = valor t student dado por 0.95 grau maior do q 120 
         * 0.95 = dado pela formula alfa/2
         * alfa = 1 - coeficiente de confiança 
         * alfa = 1 - 0,1;
         * 
         */
        ps = new PrintStream("II4.txt");
        Map<Integer, double[][]> mediasVariancias = new HashMap<Integer, double[][]>();
        for (int i = 0; i < questoes.length; i++) {
			double[] mV1 = a1.calculaMediaVariancia(melhoresProvas.get(i));
			double[] mV2 = a2.calculaMediaVariancia(melhoresProvas.get(i));
			double[] mV3 = a3.calculaMediaVariancia(melhoresProvas.get(i));
			double[] mV4 = a4.calculaMediaVariancia(melhoresProvas.get(i));
			double[] mV5 = a5.calculaMediaVariancia(melhoresProvas.get(i));
			double[][] mV =new double[5][2];
			mV[0] = mV1;
			mV[1] = mV2;
			mV[2] = mV3;
			mV[3] = mV4;
			mV[4] = mV5;
			mediasVariancias.put(questoes[i], mV);
		}
        for (int i = 0; i < questoes.length; i++) {
			double[] inter1 = a1.calculaIntervaloDeConfianca(melhoresProvas.get(i), mediasVariancias.get(questoes[i])[0], qntTestes);
			double[] inter2 = a2.calculaIntervaloDeConfianca(melhoresProvas.get(i), mediasVariancias.get(questoes[i])[1], qntTestes);
			double[] inter3 = a3.calculaIntervaloDeConfianca(melhoresProvas.get(i), mediasVariancias.get(questoes[i])[2], qntTestes);
			double[] inter4 = a4.calculaIntervaloDeConfianca(melhoresProvas.get(i), mediasVariancias.get(questoes[i])[3], qntTestes);
			double[] inter5 = a5.calculaIntervaloDeConfianca(melhoresProvas.get(i), mediasVariancias.get(questoes[i])[4], qntTestes);
			double[][] intervalo = new double[5][2];
			System.out.print(inter1[0]+" "+inter1[1]+ " ");
			ps.print(inter1[0]+" "+inter1[1]+ " ");
			System.out.print(inter2[0]+" "+inter2[1]+ " ");
			ps.print(inter2[0]+" "+inter2[1]+ " ");
			System.out.print(inter3[0]+" "+inter3[1]+ "");
			ps.print(inter3[0]+" "+inter3[1]+ " ");
			System.out.print(inter4[0]+" "+inter4[1]+ " ");
			ps.print(inter4[0]+" "+inter4[1]+ " ");
			System.out.print(inter5[0]+" "+inter5[1]+ " ");
			ps.print(inter5[0]+" "+inter5[1]+ " ");
			ps.println();
			System.out.println();
			intervalo[0] = inter1;
			intervalo[1] = inter2;
